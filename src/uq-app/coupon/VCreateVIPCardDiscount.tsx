...
export class VCreateVIPCardDiscount extends VPage<CCoupon> {
    ...
    private hanleClickCallBack = (val: any, brandid: number) => {
        let changeVipCardDiscount: any[] = []
    ...
    private onSubmit = async () => {
        ...
        let vipCardDiscountSettingCopy: any[] = [];
...
export default function SlidingBlock(props: any) {
