...
export class CMessage extends CUqBase {
    ...
    searchNowMessage = async () => {
        let messages = await this.uqs.JkseSalesTask.SearchNowMessage.table({});
    ...
    updateNowMessage = async () => {
        await this.uqs.JkseSalesTask.UpdateNowMessage.submit({});
    ...
    //搜索消息
    searchMessage = async () => {
        this.pageMessage = new QueryPager(this.uqs.JkseSalesTask.SearchMessage, 15, 30);
