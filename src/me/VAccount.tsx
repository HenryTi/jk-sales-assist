    ...
    private page = observer(() => {
        ...
        return <Page header='账户' footer={footer} >
            <div className="small mx-3 my-2">
                <span className="pr-2 text-danger ">※</span> 首次开展业务前需要绑定银行账号和身份
                <FA className="px-2 text-danger " name="exclamation-circle"></FA>
            </div>
            ...
            <div className="text-center text-white small px-2"
                style={{ width: '40%', margin: '10px auto 0 auto', padding: '4px', borderRadius: '3px', backgroundColor: '#505050', display: this.showTipss }}>
                信息还没有补充完整
            </div>
        </Page >
